...
public class KundeController {
    ...
    public void prepareContext(final Model model) {
        ...
        model.addAttribute("krankenkassenIDValues", krankenkasseRepository.findAll().stream().collect(
                Collectors.toMap(Krankenkasse::getKrankenkassenID, Krankenkasse::getKrankenkassenID)));
    }
